...
function mo_saml_show_pricing_page(){
    ...
    <?php
    echo '<form style="display:none;" id="licenseform" action="'.get_option('mo_saml_host_name').'/moas/login"
		target="_blank" method="post">
		<input type="email" name="username" value="'.get_option('mo_saml_admin_email').'" />
		<input type="text" name="redirectUrl" value="'.get_option('mo_saml_host_name').'/moas/initializepayment" /><input type="text" name="requestOrigin" id="requestOrigin2"  />
		</form>
